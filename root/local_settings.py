...
CSRF_LOCAL_TRUSTED_ORIGINS = ['https://8000-gitfor1-purepure-ai9193pd97o.ws-eu99.gitpod.io']

# ALLOWED LOCAL HOSTS :
ALLOWED_LOCAL_HOSTS = ['8000-gitfor1-purepure-ai9193pd97o.ws-eu99.gitpod.io', '127.0.0.1', 'localhost']
...
# BASE_SITE
BASE_ACTIVE_SITE = '8000-gitfor1-purepure-ai9193pd97o.ws-eu99.gitpod.io'
